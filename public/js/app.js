...
/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./search */ "./resources/js/search.js");
...
function deleteitem(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"]('/delete-item', {
    data: pizza
  }).then(function (res) {
    cartCounter.innerText = res.data.totalQty;

    // Remove the deleted item from the client-side view
    var deletedItem = document.querySelector("[data-pizza-id=\"".concat(pizza._id, "\"]"));
    if (deletedItem) {
      deletedItem.remove();
      console.log('Item removed from client-side view');
    }
    var pizzaPriceElement = document.querySelector('.amount'); // Select the element by class name or other suitable selector
    var totalPrice = res.data.totalPrice; // Calculate the total price
    console.log(pizzaPriceElement);
    console.log(totalPrice);
    // Update the content of the element
    pizzaPriceElement.textContent = "\u20B9 ".concat(totalPrice);
    new (noty__WEBPACK_IMPORTED_MODULE_0___default())({
      type: 'success',
      timeout: 1000,
...
button.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizzaItem = pizzaData.item;
    var pizzaId = pizzaData._id;
...
var sections = document.querySelectorAll('#features, .menu');
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            data.forEach(function (item) {
              ...
              itemLink.setAttribute('href', "/pizza-details/".concat(item._id)); // Include the item's ID in the URL
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoodservice"] = self["webpackChunkfoodservice"] || [];
